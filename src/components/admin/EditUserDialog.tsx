      ...
      if (role === "contractor") {
        if (!contractorId) {
          toast({
            ...
            description: "Vui lòng chọn nhà thầu cho người dùng có vai trò nhà thầu.",
            variant: "destructive",
          });
          return;
        }
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <form onSubmit={handleUpdate} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={status} onValueChange={(value) => setStatus(value as "invited" | "active" | "deactivated")}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
      ...
      <AlertDialog open={showDeactivateDialog} onOpenChange={setShowDeactivateDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bạn có chắc chắn muốn vô hiệu hóa tài khoản của {user.email}? 
